            ...
            <div class="col-12 col-sm-6">
             ...
             <div class="mt-4 d-flex w-100">
                <div class="d-flex col-sm-5">
                    <span class="btn btn-danger btn-lg btn-flat btn-minus"><b><i class="fa fa-minus"></i></b></span>
                    <input type="number" name="qty" id="qty" value="1">
                    <span class="btn btn-danger btn-lg btn-flat btn-plus"><b><i class="fa fa-plus"></i></b></span>
                </div>
              <div class="btn btn-danger btn-lg btn-flat" id="add_to_cart">
