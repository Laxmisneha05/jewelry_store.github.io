<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-danger navbar-dark ">
    ...
    <div class="container">
      ...
      <?php endif; ?>
        <li>
          <a class="nav-link text-white"  href="./" role="button"> <large><img src="LOGO.png", width="100", height="35" class="logo"  alt=""><b>&nbsp;&nbsp; Floral Fashion &nbsp;&nbsp;</b></a></large><a href="#"></a>
        </li>
      </ul>
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="width:25vw">
                ...
                <div class="d-flex bg-light justify-content-center w-100 p-2">
                    <a href="index.php?page=cart" class="btn btn-sm btn-danger btn-block col-sm-4 text-white"><i class="fa fa-edit"></i>  View Cart</a>
                </div>
              </div>
          </li>
          <li class="nav-item dropdown">
