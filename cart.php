...
<div class="col-lg-12">	
    				...
    				<div class="d-flex w-100">
    					...
    					<div class="detail-field">
    						...
    						<div class="d-flex col-sm-5">
					            <span class="btn btn-sm btn-danger btn-flat btn-minus"><b><i class="fa fa-minus"></i></b></span>
					            <input type="number" name="qty" id="" class="form-control form-control-sm qty-input" value="<?php echo $row['qty'] ?>">
					            <span class="btn btn-sm btn-danger btn-flat btn-plus"><b><i class="fa fa-plus"></i></b></span>
					        </div>
    					</div>
    ...
    <div class="col-md-4">
    	<div class="card mb-4">
    		<div class="card-header bg-danger text-white"><b>Total Amount</b></div>
    		<div class="card-body">
    			<h4 class="text-right"><b id="tamount"><?php echo number_format($total,2) ?></b></h4>
    		</div>
    	</div>
    	<button class="btn btn-block btn-danger" id="checkout" type="button">Checkout</button>
    </div>
</div>
</div>
<script>
